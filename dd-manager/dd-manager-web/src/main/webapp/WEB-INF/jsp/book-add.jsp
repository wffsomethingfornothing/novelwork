    ...
    <form class="itemForm" id="itemAddForm" name="itemAddForm" method="post">
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    <%--<input class="easyui-textbox" type="text" id="aid" name="aid"
                           data-options="required:true" style="width:200px">--%>
                        <input id="authorname" name="authorname" class="easyui-combobox" data-options="required:true" width="50px">
                        <%--把作者id带过去--%>
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" type="text" id="readpoint" name="readpoint"
