		...
		<div class="main-nav box-center cf">
			<ul>
				...
				<li class="nav-li"><a
						...
						data-eid="qd_A20">客户端</a></li>
				<li class="game phone" id="game-phone"><a class="phone-game"
														  href="http://sy.qidian.com/" target="_blank" data-eid="qd_A22">手游</a>
				...
				<li class="game web" id="game-web"><a class="web-game"
													  href="http://game.qidian.com/" target="_blank" data-eid="qd_A21">页游</a>
			...
			<dl>
				<dd>
					<a href="https://www.qidian.com/xuanhuan" target="_blank"
					   data-eid="qd_A71"><cite><span class="info"> <i class="iconfont">&#xe650;</i><i>玄幻</i></span></cite></a>
				</dd>
				<dd>
					...
					<div id="myCarousel" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="http://10.31.161.54/images/novel/1.jpg"
									 alt="First slide">
							</div>
							<div class="item">
								<img src="http://10.31.161.54/images/novel/2.jpg"
									 alt="Second slide">
							</div>
							<div class="item">
								<img src="http://10.31.161.54/images/novel/3.jpg"
									 alt="Third slide">
							</div>
							<div class="item">
								<img src="http://10.31.161.54/images/novel/4.jpg"
									 alt="Third slide">
							</div>
							<div class="item">
								<img src="http://10.31.161.54/images/novel/6.jpg"
									 alt="Third slide">
							</div>
						</div>
