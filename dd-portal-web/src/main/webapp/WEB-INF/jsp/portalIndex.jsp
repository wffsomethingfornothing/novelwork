				...
				<div class="lbf-slides switchable-slides" id="switchable-slides">
					...
					<div id="myCarousel" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<img src="http://101.132.66.226/images/novel/2.jpg"
									 alt="Second slide">
							</div>
							<div class="item">
								<img src="http://101.132.66.226/images/novel/3.jpg"
									 alt="Third slide">
							</div>
							<div class="item">
								<img src="http://101.132.66.226/images/novel/4.jpg"
									 alt="Third slide">
							</div>
							<div class="item">
								<img src="http://101.132.66.226/images/novel/5.jpg"
									 alt="Third slide">
							</div>
						</div>
