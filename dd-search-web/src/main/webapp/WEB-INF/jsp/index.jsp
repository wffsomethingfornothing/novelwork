...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script src="js/stats.js" name="MTAH5" sid="500451537"></script><script>
...
<div class="wrap">
    ...
    <div class="box-center cf">
        ...
        <div class="nav-link fl">
            <a class="act" href="https://www.qidian.com/" data-eid="qd_A01">起点中文网</a>
            <a href="https://www.qdmm.com/" target="_blank" data-eid="qd_A02">起点女生网</a><em>|</em>
    ...
    <div class="box-center cf">
        ...
        <div class="search-wrap fl">
            <form id="formUrl" action="//www.qidian.com/search" method="get" target="_blank">
                <p><input class="search-box" id="s-box" name="kw" placeholder="异世界的美食家" autocomplete="off" type="text"></p>
...
<div class="main-nav-wrap" data-l1="3">
    ...
    <dl>
        ...
        <ul>
            ...
            <li class="nav-li"><a href="https://www.qidian.com/all" data-eid="qd_A15" class="act">全部作品</a></li>
            ...
            <dl class="web-list" id="log-web-list">
                ...
                <dd data-rid="6">
                    <h3>
                        ...
                        <i>11-22</i><a href="http://cpgame.qd.game.qidian.com/Home/GameServer/lists?name=my" data-eid="qd_A36" target="_blank">起点魔域永恒</a><strong>7区</strong></h3>
...
<div class="tool-bar cf">
    ...
    <div class="select-wrap">
        ...
        <div class="sort-count count-info" id="sort-count">
            <div class="count-text">共<span>763884</span>本相关作品
            </div>
...
<li class="lbf-pagination-item"><a data-page="1" href="https://www.qidian.com/all?orderId=&amp;style=1&amp;pageSize=20&amp;siteid=1&amp;pubflag=0&amp;hiddenField=0&amp;page=1" class="lbf-pagination-page  lbf-pagination-current">1</a></li>
...
</li><li class="lbf-pagination-item"><a href="https://www.qidian.com/all?orderId=&amp;style=1&amp;pageSize=20&amp;siteid=1&amp;pubflag=0&amp;hiddenField=0&amp;page=2" class="lbf-pagination-next ">&gt;</a></li>
...
<div class="lbf-pagination-jump"><input id="PAGINATION-INPUT" class="lbf-pagination-input" value="1" type="text"><a href="javascript:;" id="PAGINATION-BUTTON" onclick="PAGINATION_goInput()" class="lbf-pagination-go">GO</a></div>
